#include "stdafx.h"
#include "StaticIniFile_EN.h"
#define LegendWidth 0.8//cm
#include "..\FunctionLib\Function_System.h"

CStaticIniFile_EN::CStaticIniFile_EN(CADLayerGroup* pLayerGroup,CADGraphics* pGraphics)
{
	m_Deep=0;
	m_FontHeight=3.5;
	m_Row1Height=25;
	...
	m_GridColWidth[8]=10;
	m_GridColWidth[9]=7;
	m_GridColWidth[10]=81;
	m_GridColWidth[11]=81;
}

CStaticIniFile_EN::~CStaticIniFile_EN()
{

}

void CStaticIniFile_EN::FileImport(LPCTSTR lpFilename)
{
...
void CStaticIniFile_EN::CreateHeader(double left,double top,double titleLeft,const char* keyName)
{
...
void CStaticIniFile_EN::CreateFoot(double left,double top)
{
/*	CADMText* pMText;
	pMText=new CADMText();
	m_pGraphics->m_Entities.Add((CObject*)pMText);
...
void CStaticIniFile_EN::CreateGrid(double GridLeft,double GridTop,double GridHeight,bool bFs,const char* keyName)
{
...
//============================================================================
	...
	m_pGraphics->m_Entities.Add((CObject*)pLine);
	pLine->m_nLayer=m_pLayerGroup->indexOf("0");
	pLine->pt1.x=pMText->m_Location.x-2;
	pLine->pt1.y=GridTop-17.5;
	pLine->pt2.x=pMText->m_Location.x+2;
	pLine->pt2.y=GridTop-17.5;
...
//============================================================================
	...
	pMText->m_Location.x+=m_GridColWidth[4]+m_GridColWidth[5]+m_GridColWidth[6];
	pMText->m_Location.x+=m_GridColWidth[7]+m_GridColWidth[8]+m_GridColWidth[9];*/
	pMText->m_Location.x = GetGridColRight(GridLeft,10);
	pMText->m_Location.x += 40-0.7;
	pMText->m_Location.y=GridTop-13.5-6.5-2;
	strcpy(pMText->m_Font,"楷体_GB2312");
...
//================================================
	if (bFs)//create grid header
	{
		...
		pMText->m_Location.x+=/*m_GridColWidth[10]+*/m_GridColWidth[11]/2;
		pMText->m_Location.y=GridTop-5;
		strcpy(pMText->m_Font,"楷体_GB2312");
		...
		pMText->m_Location.x+=m_GridColWidth[4]+m_GridColWidth[5]+m_GridColWidth[6];
		pMText->m_Location.x+=m_GridColWidth[7]+m_GridColWidth[8]+m_GridColWidth[9];
		pMText->m_Location.x+=m_GridColWidth[10]+m_GridColWidth[11]/2+12;*/
		pMText->m_Location.x = GetGridColRight(GridLeft,11);
		pMText->m_Location.x += /*m_GridColWidth[10]+*/m_GridColWidth[11]/2+12;
		...
		pMText->m_Location.x+=m_GridColWidth[4]+m_GridColWidth[5]+m_GridColWidth[6];
		pMText->m_Location.x+=m_GridColWidth[7]+m_GridColWidth[8]+m_GridColWidth[9];
		pMText->m_Location.x+=m_GridColWidth[10]+3;*/
		...
		pMText->m_Height=m_FontHeight-1;
		pMText->m_Align=AD_MTEXT_ATTACH_TOPLEFT;
		/*pMText->m_Location.x=GridLeft+m_GridColWidth[0]+m_GridColWidth[1]+GridColWidth[2]+GridColWidth[3];
		pMText->m_Location.x+=GridColWidth[4]+GridColWidth[5]+GridColWidth[6];
		pMText->m_Location.x+=GridColWidth[7]+GridColWidth[8]+GridColWidth[9];
		pMText->m_Location.x+=GridColWidth[10]+19;*/
		...
		pMText->m_Height=m_FontHeight-1;
		pMText->m_Align=AD_MTEXT_ATTACH_TOPLEFT;
		/*pMText->m_Location.x=GridLeft+GridColWidth[0]+GridColWidth[1]+GridColWidth[2]+GridColWidth[3];
		pMText->m_Location.x+=GridColWidth[4]+GridColWidth[5]+GridColWidth[6];
		pMText->m_Location.x+=GridColWidth[7]+GridColWidth[8]+GridColWidth[9];
		pMText->m_Location.x+=GridColWidth[10]+52;*/
...
//==============================================================================================
		...
		pMText->m_Location.x+=GridColWidth[4]+GridColWidth[5]+GridColWidth[6];
		pMText->m_Location.x+=GridColWidth[7]+GridColWidth[8]+GridColWidth[9];
		pMText->m_Location.x+=GridColWidth[10]+3;*/
		pMText->m_Location.x = GetGridColRight(GridLeft,11) + 3;
		pMText->m_Location.y=GridTop-13.5-6.5-2;
		strcpy(pMText->m_Font,"楷体_GB2312");
		...
		pMText->m_Location.x+=GridColWidth[4]+GridColWidth[5]+GridColWidth[6];
		pMText->m_Location.x+=GridColWidth[7]+GridColWidth[8]+GridColWidth[9];
		pMText->m_Location.x+=GridColWidth[10]+20-0.8;*/
		...
		pMText->m_Location.x+=GridColWidth[4]+GridColWidth[5]+GridColWidth[6];
		pMText->m_Location.x+=GridColWidth[7]+GridColWidth[8]+GridColWidth[9];
		pMText->m_Location.x+=GridColWidth[10]+40-0.8;*/
		...
		pMText->m_Location.x+=GridColWidth[4]+GridColWidth[5]+GridColWidth[6];
		pMText->m_Location.x+=GridColWidth[7]+GridColWidth[8]+GridColWidth[9];
		pMText->m_Location.x+=GridColWidth[10]+60-0.8;*/
		...
		pMText->m_Location.x+=GridColWidth[4]+GridColWidth[5]+GridColWidth[6];
		pMText->m_Location.x+=GridColWidth[7]+GridColWidth[8]+GridColWidth[9];
		pMText->m_Location.x+=GridColWidth[10]+78;*/
...
void CStaticIniFile_EN::Create3Curves(double GridLeft,double GridTop,double GridHeight,bool bFs,const char* keyName)
{
	int i;
	double CurveLeft = GridLeft;
	for (i=0;i<9;i++)
	...
	if (m_Deep>0)
	{
		for(int i=2;i<=m_Deep;i=i+2)
		{
			...
			pMText->m_Height = m_FontHeight-1;
			pMText->m_Align = AD_MTEXT_ATTACH_BOTTOMCENTER;
			pMText->m_Location.x = CurveLeft+m_GridColWidth[9]/2;
	...
	for (i=1;i<8;i++)
	{
		...
		pLine->pt1.x = CurveLeft;
		pLine->m_nLayer = m_pLayerGroup->indexOf("0");
		pLine->pt1.x = CurveLeft + m_GridColWidth[9]+i*10;
		pLine->pt1.y = CurveTop;
		pLine->pt2.x = CurveLeft + m_GridColWidth[9]+i*10;
		pLine->pt2.y = GridTop-GridHeight;
	}
	...
	if (bFs)
	{
		for(i=1;i<8;i++)
		{
			...
			pLine->pt1.x = CurveLeft;
			pLine->m_nLayer = m_pLayerGroup->indexOf("0");
			pLine->pt1.x = CurveLeft+m_GridColWidth[9]+m_GridColWidth[10]+i*10;
			pLine->pt1.y = CurveTop;
			pLine->pt2.x = CurveLeft+m_GridColWidth[9]+m_GridColWidth[10]+i*10;
			pLine->pt2.y = GridTop-GridHeight;
		}
	}
//create 3 curves-----------------------------------------------------------------------
	...
	if (atof(pszTemp) > fQcLimit)
		pPoint->x = CurveLeft + m_GridColWidth[9]+fQcLimit*5;
	else
		pPoint->x = CurveLeft + m_GridColWidth[9]+atof(pszTemp)*5;
...
CADBlock* CStaticIniFile_EN::CreateLayerBlock(CPerHoleLayer* pHoleLayer)
{
...
void CStaticIniFile_EN::CreateHatch(char* LegendName,CADPolyline* pPolyline)
{
...
void CStaticIniFile_EN::CreateHatchLine(char* hatchLineStr,CADHatch* pHatch)
{
...
void CStaticIniFile_EN::CreateChartFrame(float left,float top,float width,float height)
{
	CADPolyline* pPolyline;
	ADPOINT* pPoint;
	pPolyline=new CADPolyline();
...
double CStaticIniFile_EN::GetGridColRight(double GridLeft,short nCol)
{
	double colLeft;
	colLeft = GridLeft;
