#include "stdafx.h"
#include "StaticIniFile2_EN.h"
#define LegendWidth 0.8//cm
#include "..\FunctionLib\Function_System.h"

CStaticIniFile2_EN::CStaticIniFile2_EN(CADLayerGroup* pLayerGroup,CADGraphics* pGraphics)
{
	m_Deep=0;
	m_FontHeight=3.5;
	m_Row1Height=25;
...
CStaticIniFile2_EN::~CStaticIniFile2_EN()
{

}

void CStaticIniFile2_EN::FileImport(LPCTSTR lpFilename)
{
...
void CStaticIniFile2_EN::CreateHeader(double left,double top,double titleLeft,const char* keyName)
{
...
void CStaticIniFile2_EN::CreateFoot(double left,double top)
{
/*	CADMText* pMText;
	pMText=new CADMText();
	m_pGraphics->m_Entities.Add((CObject*)pMText);
...
void CStaticIniFile2_EN::CreateGrid(double GridLeft,double GridTop,double GridHeight,bool bFs,const char* keyName)
{
...
//============================================================================
	...
	pMText->m_Location.x = GetGridColRight(GridLeft,5)+m_GridColWidth[5]/2;
...
//============================================================================
	...
	pMText->m_Location.x = GetGridColRight(GridLeft,6)+m_GridColWidth[6]/2;
	pMText->m_Location.y=GridTop-2;
	strcpy(pMText->m_Font,"楷体_GB2312");
...
//============================================================================
	...
	pMText->m_Location.x = GetGridColRight(GridLeft,7)+m_GridColWidth[7]/2;
	pMText->m_Location.y=GridTop-2;
	strcpy(pMText->m_Font,"楷体_GB2312");
...
//============================================================================
	...
	pMText->m_Location.x = GetGridColRight(GridLeft,8)+m_GridColWidth[8]/2;
	pMText->m_Location.y=GridTop-4;
	strcpy(pMText->m_Font,"楷体_GB2312");
//============================================================================
...
void CStaticIniFile2_EN::Create3Curves(double GridLeft,double GridTop,double GridHeight,bool bFs,const char* keyName)
{
	int i;
	double CurveLeft = GridLeft;
	for (i=0;i<8;i++)
...
CADBlock* CStaticIniFile2_EN::CreateLayerBlock(CPerHoleLayer* pHoleLayer)
{
...
void CStaticIniFile2_EN::CreateHatch(char* LegendName,CADPolyline* pPolyline)
{
...
void CStaticIniFile2_EN::CreateHatchLine(char* hatchLineStr,CADHatch* pHatch)
{
...
void CStaticIniFile2_EN::CreateChartFrame(float left,float top,float width,float height)
{
	CADPolyline* pPolyline;
	ADPOINT* pPoint;
	pPolyline=new CADPolyline();
...
double CStaticIniFile2_EN::GetGridColRight(double GridLeft,short nCol)
{
	double colLeft;
	colLeft = GridLeft;
