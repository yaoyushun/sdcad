...
//check special legend---------------------
	...
	else if (strcmp(strCN,"·ÛÏ¸É°")==0)
	{
		strcpy(pHatch->m_Name,"É°");
		legendCharIndex = 0;	
	}
	else if (strcmp(strCN,"·ÛÉ°¼ÐÏ¸É°")==0)
	{
		strcpy(pHatch->m_Name,"É°");
		legendCharIndex = 0;	
	}
	...
	else if (strcmp(strCN,"ÖÐÏ¸É°")==0)
	{
		strcpy(pHatch->m_Name,"É°");
		legendCharIndex = 2;	
	}
	else if (strcmp(strCN,"ÖÐ´ÖÉ°")==0)
	{
		strcpy(pHatch->m_Name,"É°");
		legendCharIndex = 2;	
	}
	else if (strcmp(strCN,"´ÖÉ°")==0)
	{
		strcpy(pHatch->m_Name,"É°");
		legendCharIndex = 3;	
	}
	else if (strcmp(strCN,"ÀùÉ°")==0)
	{
		strcpy(pHatch->m_Name,"É°");
		legendCharIndex = 4;	
	}
	else if (strcmp(strCN,"·ÛÉ°ÑÒ")==0)
	{
		strcpy(pHatch->m_Name,"É°ÑÒ");
		legendCharIndex = 0;	
	}
	else if (strcmp(strCN,"Ï¸É°ÑÒ")==0)
	{
		strcpy(pHatch->m_Name,"É°ÑÒ");
		legendCharIndex = 1;	
	}
	else if (strcmp(strCN,"ÖÐÉ°ÑÒ")==0)
	{
		strcpy(pHatch->m_Name,"É°ÑÒ");
		legendCharIndex = 2;	
	}
	else if (strcmp(strCN,"´ÖÉ°ÑÒ")==0)
	{
		strcpy(pHatch->m_Name,"É°ÑÒ");
		legendCharIndex = 3;	
	}
	else if (strcmp(strCN,"º¬Àù·ÛÉ°ÑÒ")==0)
	{
		legendCharIndex = 0;	
	}
	...
	else if (strcmp(strCN,"º¬ÀùÉ°·ÛÖÊÕ³ÍÁ")==0)
	{
		legendCharIndex = 4;	
	}
	else if (strcmp(strCN,"º¬ÀùÉ°Õ³ÍÁ")==0)
	{
		legendCharIndex = 4;	
	}
	else if (strcmp(strCN,"º¬ÀùÉ°ÓÙÄàÖÊ·ÛÖÊÕ³ÍÁ")==0)
	{
		legendCharIndex = 4;	
	}
	else if (strcmp(strCN,"º¬Õ³ÐÔÍÁ·ÛÉ³")==0)
	{
		legendCharIndex = 0;	
	}
	else if (strcmp(strCN,"º¬Õ³ÐÔÍÁÏ¸É³")==0)
	{
		legendCharIndex = 1;	
	}
	else if (strcmp(strCN,"º¬Õ³ÐÔÍÁÖÐÉ³")==0)
	{
		legendCharIndex = 2;	
	}
	else if (strcmp(strCN,"º¬Õ³ÐÔÍÁ´ÖÉ³")==0)
	{
		legendCharIndex = 3;	
	}
	else if (strcmp(strCN,"º¬Õ³ÐÔÍÁÀùÉ³")==0)
	{
		legendCharIndex = 4;	
	}
//-----------------------------------------
...
//------------------------------------------------------
	...
	pMText->m_Align = AD_MTEXT_ATTACH_MIDDLELEFT;
	//pMText->m_Text = legendName;
	bool specailText = false;
	if (strcmp(strEN,"Strata boundary Presumed strata boundary")==0)
	{
		specailText = true;
		strEN = "Strata boundary\r\nPresumed strata boundary";
	}
	pMText->m_Text = strEN;
	strcpy(pMText->m_Font,ENFONTNAME);
	...
	pMText->m_Height=3.5;
	if (specailText)
		pMText->m_Width = m_MTextWidth*2;
	else
		pMText->m_Width = m_MTextWidth;
	pMText->m_Location.x=legendLeft+m_LegendWidth+5.5;
	if (specailText)
		pMText->m_Location.y=legendTop-m_LegendHeight/3;
	else
		pMText->m_Location.y=legendTop-m_LegendHeight/2;
	pMText->m_isWarp = true;	
}
...
void CLegendDisplay::CreateChartFooter(LPCTSTR lpFilename)
{
	...
	m_pGraphics->m_Entities.Add((CObject*)pMText);
	pMText->m_nLayer=curLayerIndex;
	pMText->m_Text="Page           of           ";//"µÚ   ÕÅ ¹²   ÕÅ";
	strcpy(pMText->m_Font,ENFONTNAME);
	pMText->m_Height=3.5;
	pMText->m_Align=AD_MTEXT_ATTACH_MIDDLECENTER;
	pMText->m_Location.x = GridLeft+GridColWidth[0]+GridColWidth[1]+GridColWidth[2];
