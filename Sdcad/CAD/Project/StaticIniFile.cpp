#include "stdafx.h"
#include "StaticIniFile.h"
#define LegendWidth 0.8//cm
#include "..\FunctionLib\Function_System.h"

CStaticIniFile::CStaticIniFile(CADLayerGroup* pLayerGroup,CADGraphics* pGraphics)
{
	m_Deep=0;
	m_FontHeight=3.5;
	m_Row1Height=25;
...
CStaticIniFile::~CStaticIniFile()
{

}

void CStaticIniFile::FileImport(LPCTSTR lpFilename)
{
...
void CStaticIniFile::CreateHeader(double left,double top,double titleLeft,const char* keyName)
{
...
void CStaticIniFile::CreateFoot(double left,double top)
{
/*	CADMText* pMText;
	pMText=new CADMText();
	m_pGraphics->m_Entities.Add((CObject*)pMText);
...
void CStaticIniFile::CreateGrid(double GridLeft,double GridTop,double GridHeight,bool bFs,const char* keyName)
{
...
//============================================================================
	...
	//
		...
		pMText->m_Location.x=GridLeft+m_GridColWidth[0]+m_GridColWidth[1]+m_GridColWidth[2]+m_GridColWidth[3];
		pMText->m_Location.x+=m_GridColWidth[4]+m_GridColWidth[5]+m_GridColWidth[6]+m_GridColWidth[7];
		pMText->m_Location.x+=m_GridColWidth[8]/2 + 1.25;
...
void CStaticIniFile::Create3Curves(double GridLeft,double GridTop,double GridHeight,bool bFs,const char* keyName)
{
	int i;
	double CurveLeft = GridLeft;
	for (i=0;i<9;i++)
...
CADBlock* CStaticIniFile::CreateLayerBlock(CPerHoleLayer* pHoleLayer)
{
...
void CStaticIniFile::CreateHatch(char* LegendName,CADPolyline* pPolyline)
{
...
void CStaticIniFile::CreateHatchLine(char* hatchLineStr,CADHatch* pHatch)
{
...
void CStaticIniFile::CreateChartFrame(float left,float top,float width,float height)
{
	CADPolyline* pPolyline;
	ADPOINT* pPoint;
	pPolyline=new CADPolyline();
...
double CStaticIniFile::GetGridColRight(double GridLeft,short nCol)
{
	double colLeft;
	colLeft = GridLeft;
