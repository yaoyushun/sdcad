#ifndef __HistogramIniFile2_H__
#define __HistogramIniFile2_H__

#include "..\AutoCAD\ADLayerGroup.h"
#include "..\AutoCAD\ADGraphics.h"
#include "ProjectLayer.h"

class CHistogramIniFile2
{
public:
	short m_ProjectType;
	short m_nPaperCount;
	void FileImport(LPCTSTR lpFilename);
	CHistogramIniFile2(CADLayerGroup* pLayerGroup,CADGraphics* pGraphics);
	~CHistogramIniFile2();
private:
	...
	void DrawRect(double left,double top,double width,double height,int curLayerIndex);
