...
Resource2=IDR_MENU_EDIT
Resource3=IDD_LAYER_ADMIN
Resource4=IDD_DLG_TEXT
Resource5=IDD_INSERTBLOCKDLG
Class5=CChildFrame
Class6=CAboutDlg
Resource6=IDD_DLG_SECTION
Resource7=IDD_INSERTBLOCKDLG (Chinese (P.R.C.))
Class7=CInsertBlockDlg
Resource8=IDR_TOOLBAR5
Class8=CDlgTextEdit
Resource9=IDR_MENU_PAPER
Class9=CInsertHoleLayerDlg
Resource10=IDD_DIALOG1 (Chinese (P.R.C.))
Class10=CDlg_PaperSetup
Resource11=IDR_MINICATYPE
Resource12=IDD_DIG_ENTITYPROPERTY
Class11=CDlgSection
Resource13=IDR_TOOLBAR1
Class12=CDlgCompass
Resource14=IDR_TOOLBAR3
Resource15=IDR_TOOLBAR4
Class13=CDlgEntityProperty
Resource16=IDR_TOOLBAR2
Resource17=IDD_DIG_PAPERSETUP
Resource18=IDD_INSERTHOLELAYERDLG
Resource19=IDD_DIG_ENTITYPROPERTY (Chinese (P.R.C.))
Resource20=IDR_MINICATYPE (Chinese (P.R.C.))
Resource21=IDD_DLG_COMPASS (Chinese (P.R.C.))
Resource22=IDD_DLG_SECTION (Chinese (P.R.C.))
Resource23=IDD_DLG_TEXT (Chinese (P.R.C.))
Resource24=IDR_MENU_PAPER (Chinese (P.R.C.))
Resource25=IDR_TOOLBAR3 (Chinese (P.R.C.))
Resource26=IDD_LAYER_ADMIN (Chinese (P.R.C.))
Resource27=IDD_INSERTHOLELAYERDLG (Chinese (P.R.C.))
Resource28=IDD_DIG_PAPERSETUP (Chinese (P.R.C.))
Resource29=IDR_MAINFRAME (Chinese (P.R.C.))
Resource30=IDR_MENU_EDIT (Chinese (P.R.C.))
Resource31=IDR_TOOLBAR2 (Chinese (P.R.C.))
Resource32=IDR_TOOLBAR4 (Chinese (P.R.C.))
Resource33=IDR_TOOLBAR5 (Chinese (P.R.C.))
Resource34=IDR_TOOLBAR1 (Chinese (P.R.C.))
Resource35=IDD_ABOUTBOX (Chinese (P.R.C.))
Resource36=IDD_DLG_COMPASS
