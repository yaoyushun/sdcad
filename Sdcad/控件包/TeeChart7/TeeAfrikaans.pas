...
Var TeeAfrikaansLanguage:TStringList=nil;

Procedure TeeSetAfrikaans;
Procedure TeeCreateAfrikaans;

implementation

Uses SysUtils, TeeConst, TeeProCo {$IFNDEF D5},TeCanvas{$ENDIF};

Procedure TeeAfrikaansConstants;
begin
...
Procedure TeeCreateAfrikaans;
begin
  if not Assigned(TeeAfrikaansLanguage) then
  begin
    TeeAfrikaansLanguage:=TStringList.Create;
    TeeAfrikaansLanguage.Text:=
...
begin
  TeeCreateAfrikaans;
  TeeLanguage:=TeeAfrikaansLanguage;
  TeeAfrikaansConstants;
end;

initialization
finalization
  FreeAndNil(TeeAfrikaansLanguage);
end.
