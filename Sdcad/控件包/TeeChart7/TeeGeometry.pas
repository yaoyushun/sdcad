...
procedure VectorNegate(const V: array of Single);
function  VectorNorm(const V: array of Single): Single;
function  VectorNormalize(const V: array of Single): Single;
...
procedure VectorScale(const V: array of Single; const Factor: Single);
...
function  MakeAffineDblVector(const V: array of Double): TAffineDblVector;
function  MakeDblVector(const V: array of Double): THomogeneousDblVector;
function  MakeAffineVector(const V: array of Single): TAffineVector;
function  MakeVector(const V: array of Single): TVector;
function  PointInPolygon(const xp, yp : array of Single; const x,y: Single): Boolean;
...
function MakeAffineDblVector(const V: array of Double): TAffineDblVector; register; assembler;
...
function MakeDblVector(const V: array of Double): THomogeneousDblVector; register; assembler;
...
function MakeAffineVector(const V: array of Single): TAffineVector; register; assembler;
...
function MakeVector(const V: array of Single): TVector; register; assembler;
...
function VectorLength(const V: array of Single): Single; register; assembler;
...
function VectorAngle(const V1,V2: TAffineVector): Single; register; assembler;
...
function QuaternionConjugate(const Q: TQuaternion): TQuaternion; register; assembler;
...
function QuaternionFromPoints(const V1,V2: TAffineVector): TQuaternion; register; assembler;
...
function QuaternionMultiply(const qL, qR: TQuaternion): TQuaternion; register;
...
function QuaternionToMatrix(const Q: TQuaternion): TMatrix; register;
...
procedure QuaternionToPoints(const Q: TQuaternion; var ArcFrom, ArcTo: TVector); register;
...
function VectorNorm(const V: array of Single): Single; assembler; register;
...
function VectorNormalize(const V: array of Single): Single; assembler; register;
...
function VectorAffineSubtract(const V1,V2: TAffineVector): TAffineVector; register;
...
procedure VectorScale(const V: array of Single; const Factor: Single); assembler; register;
...
procedure VectorNegate(const V: array of Single); assembler; register;
...
function VectorAffineDotProduct(const V1,V2: TAffineVector): Single; register;
...
function VectorPerpendicular(const V, N: TAffineVector): TAffineVector; register;
...
procedure MatrixScale(var M: TMatrix; const Factor: Single); register;
...
function CreateRotationMatrix(const Axis: TAffineVector; const Angle: Single): TMatrix; register;
...
function VectorDblToFlt(const V: THomogeneousDblVector): THomogeneousVector; register; assembler;
...
function VectorAffineDblToFlt(const V: TAffineDblVector): TAffineVector; register; assembler;
...
function VectorAffineFltToDbl(const V: TAffineVector): TAffineDblVector; register; assembler;
...
function VectorFltToDbl(const V: TVector): THomogeneousDblVector; register; assembler;
