...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiToolBarSpeedButton(HWND ParentWindow) : Extctrls::TCustomPanel(ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiButton(HWND ParentWindow) : TsuiCustomButton(ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiCheckBox(HWND ParentWindow) : Controls::TCustomControl(ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiRadioButton(HWND ParentWindow) : TsuiCheckBox(ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TsuiCustomButton.Create */ inline __fastcall virtual TsuiArrowButton(Classes::TComponent* AOwner) : TsuiCustomButton(AOwner) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiArrowButton(HWND ParentWindow) : TsuiCustomButton(ParentWindow) { }
	#pragma option pop
