...
// (DO NOT EDIT: machine generated header) 'SUIToolBar.pas' rev: 6.00
...
private:
	...
	void __fastcall DrawDownButton(Graphics::TCanvas* ACanvas, const Types::TRect &ARect, Imglist::TCustomImageList* ImgLst, int ImageIndex, AnsiString Caption, bool DropDown);
	void __fastcall DrawHotButton(Graphics::TCanvas* ACanvas, const Types::TRect &ARect, Imglist::TCustomImageList* ImgLst, int ImageIndex, AnsiString Caption, bool DropDown);
