...
// (DO NOT EDIT: machine generated header) 'frmMessage.pas' rev: 6.00
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TfrmMsg(Classes::TComponent* AOwner) : Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrmMsg(Classes::TComponent* AOwner, int Dummy) : Forms::TForm(AOwner, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
