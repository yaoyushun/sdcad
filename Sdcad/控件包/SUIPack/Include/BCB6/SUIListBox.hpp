...
__published:
	...
	__property Graphics::TColor SelectedTextColor = {read=FSelectedTextColor, write=SetSelectedTextColor, default=-2147483634};
	__property Graphics::TColor DisabledTextColor = {read=FDisabledTextColor, write=SetDisabledTextColor, default=-2147483631};
