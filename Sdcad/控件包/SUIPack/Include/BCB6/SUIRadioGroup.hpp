...
// (DO NOT EDIT: machine generated header) 'SUIRadioGroup.pas' rev: 6.00
...
public:
	...
	/* TWinControl.CreateParented */ inline __fastcall TsuiCheckGroup(HWND ParentWindow) : Suigroupbox::TsuiCustomGroupBox(ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TsuiCheckGroup.Create */ inline __fastcall virtual TsuiRadioGroup(Classes::TComponent* AOwner) : TsuiCheckGroup(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiRadioGroup(HWND ParentWindow) : TsuiCheckGroup(ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiCheckGroupButton(HWND ParentWindow) : Suibutton::TsuiCheckBox(ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiRadioGroupButton(HWND ParentWindow) : Suibutton::TsuiRadioButton(ParentWindow) { }
	#pragma option pop
