...
// (DO NOT EDIT: machine generated header) 'SUISideChannel.pas' rev: 5.00
...
public:
	...
	void __fastcall Pop(bool bQuick);
	void __fastcall Push(bool bQuick);
...
public:
	...
	/* TWinControl.CreateParented */ inline __fastcall TsuiSideChannel(HWND ParentWindow) : Extctrls::TCustomPanel(
		ParentWindow) { }
	#pragma option pop
