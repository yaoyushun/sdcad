...
// (DO NOT EDIT: machine generated header) 'SUIComboBox.pas' rev: 5.00
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiCustomComboBox(HWND ParentWindow) : Stdctrls::TCustomComboBox(
		ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TsuiCustomComboBox.Create */ inline __fastcall virtual TsuiComboBox(Classes::TComponent* AOwner)
		 : TsuiCustomComboBox(AOwner) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiComboBox(HWND ParentWindow) : TsuiCustomComboBox(
		ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiDriveComboBox(HWND ParentWindow) : Filectrl::TDriveComboBox(
		ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiFilterComboBox(HWND ParentWindow) : Filectrl::TFilterComboBox(
		ParentWindow) { }
	#pragma option pop
