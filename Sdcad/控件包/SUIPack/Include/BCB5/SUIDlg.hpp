...
// (DO NOT EDIT: machine generated header) 'SUIDlg.pas' rev: 5.00
...
public:
	...
	virtual Forms::TModalResult __fastcall ShowModal(void) = 0 ;
...
private:
	...
	Forms::TModalResult m_Button1ModalResult;
	Forms::TModalResult m_Button2ModalResult;
	Forms::TModalResult m_Button3ModalResult;
	TsuiIconType m_IconType;
	AnsiString m_Text;
	
public:
	__fastcall virtual TsuiMessageDialog(Classes::TComponent* AOwner);
	virtual Forms::TModalResult __fastcall ShowModal(void);
...
__published:
	...
	__property Forms::TModalResult Button1ModalResult = {read=m_Button1ModalResult, write=m_Button1ModalResult
		, nodefault};
	__property Forms::TModalResult Button2ModalResult = {read=m_Button2ModalResult, write=m_Button2ModalResult
		, nodefault};
	__property Forms::TModalResult Button3ModalResult = {read=m_Button3ModalResult, write=m_Button3ModalResult
		, nodefault};
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE Forms::TModalResult __fastcall SUIMsgDlg(const AnsiString Msg, Dialogs::TMsgDlgType DlgType
	, Dialogs::TMsgDlgButtons Buttons, Suithemes::TsuiUIStyle UIStyle)/* overload */;
extern PACKAGE Forms::TModalResult __fastcall SUIMsgDlg(const AnsiString Msg, const AnsiString Caption
	, Dialogs::TMsgDlgType DlgType, Dialogs::TMsgDlgButtons Buttons, Suithemes::TsuiUIStyle UIStyle)/* overload */
	;
