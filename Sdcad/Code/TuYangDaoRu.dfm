object TuYangDaoRuForm: TTuYangDaoRuForm
  Left = 322
  Top = 221
  BorderStyle = bsDialog
  Caption = #22303#24037#35797#39564#25968#25454#23548#20837'(KTG)'
  ClientHeight = 476
  ClientWidth = 689
  Color = clBtnFace
  ...
  object OpenDialog1: TOpenDialog
    Filter = '*.KTG|*.KTG|*.DAT|*.DAT|*.TXT|*.TXT|*.*|*.*'
    Left = 241
    Top = 281
  end
end
