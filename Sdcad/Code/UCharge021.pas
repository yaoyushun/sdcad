...
uses
  ...
  ComCtrls,Dialogs, StdCtrls, ADODB, DB,ComObj,  Buttons,shellapi,Inifiles;
...
type
  ...
  private
    ...
    strRecord:Array[0..12] of String;
...
begin
    ...
    begin
        copyfile(pChar(GetCurrentDir +'\XLS\XMJS041018_02.xls'),pChar(ERP1.text),True);
    end;
...
procedure TfrmCharge02.FormCreate(Sender: TObject);
var
    ini_file:TInifile;
begin
