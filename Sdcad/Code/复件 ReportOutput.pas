...
begin
    ...
    ExcelApplication1.Cells(17,4+intTag):=zhuantanland_all[20];     //钻探,陆上工作量(20~30米,I)
    ExcelApplication1.Cells(18,4+intTag):=zhuantanland_all[21];     //钻探,陆上工作量(20~30米,II)
    ExcelApplication1.Cells(19,4+intTag):=zhuantanland_all[22];     //钻探,陆上工作量(20~30米,III)

    ExcelApplication1.Cells(20,4+intTag):=zhuantanland_all[30];     //钻探,陆上工作量(30~40米,I)
    ExcelApplication1.Cells(21,4+intTag):=zhuantanland_all[31];     //钻探,陆上工作量(30~40米,II)
    ExcelApplication1.Cells(22,4+intTag):=zhuantanland_all[32];     //钻探,陆上工作量(30~40米,III)

    ExcelApplication1.Cells(23,4+intTag):=zhuantanland_all[40];     //钻探,陆上工作量(40~50米,I)
    ExcelApplication1.Cells(24,4+intTag):=zhuantanland_all[41];     //钻探,陆上工作量(40~50米,II)
    ExcelApplication1.Cells(25,4+intTag):=zhuantanland_all[42];     //钻探,陆上工作量(40~50米,III)

    ExcelApplication1.Cells(26,4+intTag):=zhuantanland_all[50];     //钻探,陆上工作量(50~75米,I)
    ExcelApplication1.Cells(27,4+intTag):=zhuantanland_all[51];     //钻探,陆上工作量(50~75米,II)
    ExcelApplication1.Cells(28,4+intTag):=zhuantanland_all[52];     //钻探,陆上工作量(50~75米,III)

    ExcelApplication1.Cells(29,4+intTag):=zhuantanland_all[60];     //钻探,陆上工作量(75~100米,I)
    ExcelApplication1.Cells(30,4+intTag):=zhuantanland_all[61];     //钻探,陆上工作量(75~100米,II)
    ExcelApplication1.Cells(31,4+intTag):=zhuantanland_all[62];     //钻探,陆上工作量(75~100米,III)
